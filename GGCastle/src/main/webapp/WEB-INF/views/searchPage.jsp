...
<body id="page-top">
                    ...
                    <form action="/search" method="get"
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2" name="searchId">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" id="member_id">${member.id }</span>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>USER_EMAIL</th>
                                            <th>AUTH_KEY</th>
                                            <th>current USER_LOCK</th>
                                            <th>generate new key</th>
                                            <th>lock</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
											...
											<input type="hidden" id="user_id" value="${findUser.id }">
												...
												<td>${findUser.apiKey}</td>
												<td>${findUser.user_lock}</td>
												<td><button class ="btn btn-primary" type="button" onclick="newKey()">
												generate</button></td>
											</c:if>
											<c:if test="${findUser.user_lock == true }">
												<td><button class ="btn btn-primary" type="button" onclick="lock()">
												off</button></td>
											</c:if>
											<c:if test="${findUser.user_lock == false }">
												<td><button class ="btn btn-primary" type="button" onclick="lock()">
												on</button></td>
											</c:if>
                                        </tr>
    ...
    <script src="/js/admin/manageByAdmin.js?ver=1"></script>
