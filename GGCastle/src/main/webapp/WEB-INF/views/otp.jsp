...
<link href="/vendor/fontawesome-free/css/all.min.css?ver=1"
...
<body class="bg-gradient-primary">
			...
			<div class="col-xl-10 col-lg-12 col-md-9">
				...
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="card-body p-0">
						...
						<div class="row">
							<img src="https://source.unsplash.com/Mv9hjnEUHR4/464x537" />
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">OTP Authentication
											Page!</h1>
									</div>
									...
									<form class="user">
										<div class="form-group">
											...
											<button id="btn-auth" type="button"
												class="btn btn-primary btn-user btn-block">Certify
											</button>
									</form>
	...
	<script  src="http://code.jquery.com/jquery-latest.min.js?ver=1"></script>

	<script src="/vendor/jquery/jquery.min.js?ver=1"></script>
	<script
		src="/vendor/bootstrap/js/bootstrap.bundle.min.js?ver=1"></script>
	...
	<script src="/js/user/user-auth.js?ver=1"></script>
</body>
